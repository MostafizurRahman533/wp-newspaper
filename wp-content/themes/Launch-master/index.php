...
<head>
	...
	<!--Fonts-->
	<link href="<?php echo get_template_directory_uri(); ?>/assets/css/awsome.css" rel="stylesheet">
	<link href='<?php echo get_template_directory_uri(); ?>/assets/css/icon.css' rel='stylesheet' type='text/css'>
				...
				<div class="content col-md-4 col-sm-12 col-xs-12">
					<div class="section-block summary">
						...
						<div class="profile-contents">
							...
							<img src="<?php echo get_template_directory_uri(); ?>/assets/img/profile-img.jpg" class="profile-image img responsive" alt="John Doe">
							<!--social links-->
