<div class="wrapper col6">
  <div id="footer">
    ...
    <div class="footbox flickr">
      ...
      <ul>
        <li><a href="#"><img src="<?php echo get_template_directory_uri();?>/images/demo/80x80.gif" alt="" /></a></li>
        <li><a href="#"><img src="<?php echo get_template_directory_uri();?>/images/demo/80x80.gif" alt="" /></a></li>
        <li><a href="#"><img src="<?php echo get_template_directory_uri();?>/images/demo/80x80.gif" alt="" /></a></li>
        <li><a href="#"><img src="<?php echo get_template_directory_uri();?>/images/demo/80x80.gif" alt="" /></a></li>
        <li><a href="#"><img src="<?php echo get_template_directory_uri();?>/images/demo/80x80.gif" alt="" /></a></li>
    ...
    <div class="footbox banners last">
      ...
      <ul>
        <li><a href="#"><img src="<?php echo get_template_directory_uri();?>/images/demo/200x150.gif" alt="" /></a></li>
        <li><a href="#"><img src="<?php echo get_template_directory_uri();?>/images/demo/200x150.gif" alt="" /></a></li>
      </ul>
    </div>
    <br class="clear" />
...
<div class="wrapper col7">
  <div id="copyright">
    ...
    <p class="fl_right">Template by <a target="_blank" href="<?php echo get_template_directory_uri();?>/http://www.os-templates.com/" title="Free Website Templates">OS Templates</a></p>
    <br class="clear" />
  </div>
</div>
<?php wp_footer(); ?>
