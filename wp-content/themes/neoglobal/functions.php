...
?>
	...
	<table class="form-table">
		...
		<tr>
			<th><label for="facebook">Github</label></th>
			<td>
				<input type="text" name="github" id="github" value="<?php echo esc_attr( get_the_author_meta( 'github', $user->ID ) ); ?>" class="regular-text" /><br />
				<span class="description">Please enter your github username. [e.g http://www.github.com/username]</span>
			</td>
		</tr>
				<tr>
			...
			<td>
				...
				<tr>
			<th><label for="facebook">Twiter</label></th>
			<td>
				<input type="text" name="twiter" id="twiter" value="<?php echo esc_attr( get_the_author_meta( 'twiter', $user->ID ) ); ?>" class="regular-text" /><br />
				<span class="description">Please enter your twiter username. [e.g http://www.twiter.com/username]</span>
			</td>
		</tr>
	</table>
<?php } 